...
vision_ctrl = rm_ctrl.VisionCtrl(event, gimbal_ctrl)
...
def stop():
    ...
    logger.error('set script has stopped custom')
...
SCRATCH_PYTHON_CODE
    ...
    logger.error('MAIN: script exit, message: custom')
    logger.error('TRACEBACK:\n' + _error_msg)
finally:
    logger.error('finally del')
